...
def analysis_data_view(request, test, project):
    ...
    results = SampleResult.objects.select_related().filter(test=test, sample__subject__location__project=project).values(
        ...
        'sample__subject__second_booster',
        ...
        'sample__subject__second_booster_month',
        'sample__subject__second_booster_year',
    ...
    column_map = {
        ...
        'sample__subject__booster_year': "COVID-19 Vaccine Booster Year",
        'sample__subject__second_booster': "COVID-19 Vaccine Second Booster",
        'sample__subject__second_booster_month': "COVID-19 Vaccine Second Booster Month",
        'sample__subject__second_booster_year': "COVID-19 Vaccine Second Booster Year",
