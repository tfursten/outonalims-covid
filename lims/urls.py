...
urlpatterns = [
    ...
    path('samples/event/<str:event_id>/<str:label_paper>/<str:start_position>/<str:replicates>/<str:sort_by1>/<str:sort_by2>/<str:sort_by3>/sample_label_pdf/', views.sample_labels_pdf, name="sample_label_pdf"),
